...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a4066860-b632-439d-87d4-5be60954584e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Glitch_net;
	wire [0:0] tmpFB_0__Pin_Glitch_net;
	wire [0:0] tmpIO_0__Pin_Glitch_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Glitch_net;
	electrical [0:0] tmpSIOVREF__Pin_Glitch_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Glitch
		 (.oe(tmpOE__Pin_Glitch_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Glitch_net[0:0]}),
		  .io({tmpIO_0__Pin_Glitch_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Glitch_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Glitch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Glitch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
